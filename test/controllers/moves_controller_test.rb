...
class MovesControllerTest < ActionController::TestCase
  ...
  test "should create move" do
    assert_difference('Move.count') do
      post :create, move: { actor_id: @move.actor_id, description: @move.description, genre_id: @move.genre_id, name: @move.name, rating: @move.rating }
    end
  ...
  test "should update move" do
    patch :update, id: @move, move: { actor_id: @move.actor_id, description: @move.description, genre_id: @move.genre_id, name: @move.name, rating: @move.rating }
    assert_redirected_to move_path(assigns(:move))
  end
